				...
				<Grid container className={classes.joinUsItemsInside}>
					...
					>
						<Grid item className={classes.itemPointsImage}>
							<img src={KnowledgeSharing} alt="KnowledgeSharing" style={{ width: "80%" }}/>
						</Grid>
					...
					>
						<Grid item className={classes.itemPointsImage}>
							<img src={discrimination} alt="discrimination" style={{ width: "80%" }}/>
						</Grid>
						<Grid item className={classes.itemPointsTitle}>
							{t("itemPointsTitle3")}
						</Grid>
				...
				<Grid container justify="center">
					<Link href="/working-at-digi2world">
						<a style={{ textDecoration: "none" }}>
							<Button variant="contained" className={classes.moreAboutButton}>
								{t("moreAboutWorking")}
							</Button>
						</a>
					</Link>
