...
export default function OurValuesDrivePage() {
  ...
  return (
    <Grid container className={classes.OurValuesDriveBoxMobile}>
      <Grid container className={classes.ourValuesDriveRow}>
        <Typography variant="h3" className={classes.ourValuesDriveTitleMobile}>
          {t("OurValuesDrive")}
        </Typography>
        <Typography variant="body1" className={classes.ourValuesDriveDescription}>
          {t("OurValuesDriveDescription")}
        </Typography>
        <Grid item className={classes.titleUnderLine2Mobile} />
      </Grid>
